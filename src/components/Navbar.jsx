    ...
    <nav className="bg-gradient fixed top-0 w-full z-20">
      ...
      <div className={`md:hidden ${menuOpen ? "block" : "hidden"} bg-gradient`}>
        <div className="px-2 pt-2 pb-3 space-y-1">
          <Link
            to="/"
            className="block text-[#BB8D42] hover:bg-slate-300/10 px-3 py-2 rounded-md  font-light"
          >
            <ScrollLink
              to="hero"
              smooth={true}
          ...
          <Link to="/#nosotros">
            <ScrollLink
              className="block text-white hover:bg-slate-300/10 px-3 py-2 rounded-md  font-light"
              to="nosotros"
              smooth={true}
              offset={-70}
              duration={500}
