...
// api/uf.js
var SERIE_UF = "F073.UFF.PRE.Z.D";
var fmtFecha = /* @__PURE__ */ __name((d) => d.toISOString().slice(0, 10), "fmtFecha");
async function onRequestGet({ env }) {
  ...
  try {
    ...
    const url = `https://si3.bcentral.cl/SieteRestWS/SieteRestWS.ashx?user=${encodeURIComponent(user)}&pass=${encodeURIComponent(pass)}&function=GetSeries&timeseries=${SERIE_UF}&firstdate=${fmtFecha(desde)}&lastdate=${fmtFecha(hasta)}`;
    ...
    if (!valor) {
      return new Response(
        JSON.stringify({ error: "Respuesta del BCCh sin valor de UF v\xE1lido" }),
        { status: 502, headers }
      );
    }
...
// ../.wrangler/tmp/pages-tx3eLk/functionsRoutes-0.42707254363090086.mjs
var routes = [
  {
    routePath: "/api/uf",
    mountPath: "/api",
...
// ../.wrangler/tmp/bundle-ynNNj8/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-ynNNj8/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.6365644689257948.mjs.map
